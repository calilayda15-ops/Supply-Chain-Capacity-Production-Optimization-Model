...
Using **Python**, **Pandas**, and **Matplotlib**, I developed a simulation engine that tests all 25 possible operational paths to pinpoint the exact global minimum cost strategy and visualized the structural cost dynamics.
...
The generated chart visually demonstrates how delay impacts cumulative costs. The green indicator marks the absolute mathematical minimum for warehouse operations:
![Optimization Chart](capacity_optimization_chart.png)
---
